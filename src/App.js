...
function MenuModal (props) {
  return (
    <div className="content">
        <img src="./new_game.png" alt="New game" className="img_info"/>
  ...
  return (
    <div className="content">
        <div className="paragraph paragraph_win">
          ...
          <img className="win_pic" src="./congratulations.png" alt="win_pic"/>
        </div>
    </div>
  )
}
...
class App extends Component {
  constructor(props) {
    ...
    this.state= {
      ...
      score: 0,
      clock: 0,
      modal: <HelpModal closeModal={this.closeModal}/>
    }
...
// clock
  ...
  openModal = (modalName) => e => {
    switch (modalName) {
      case 'instruction':
        this.setState({modal: <HelpModal closeModal={this.closeModal}/>})
        break
      case 'info':
        this.setState({
          modal:
  ...
  render() {
    ...
    <div className="container" >
        <div className="header">
          <div className="nav">
            <img className="more_info icon" src="menu.png" alt="more" onClick={this.openModal('info')}/>
            ...
            <img className="back_tab icon" src="back.png" alt="return" onClick={this.undo()}/>
            <img className="help_tab icon" src="help.png" alt="return" onClick={this.openModal('instruction')}/>
          </div>
